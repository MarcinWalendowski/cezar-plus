...
Additive and optional throughout, which matters because cezar is published (`@loki-labs/better-cezar`) and persisted older runs must still parse and resume. No migration, no dual write, no reset of stored state.
