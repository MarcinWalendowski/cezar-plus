...
- **Supersedes (partially):** `.ai/specs/2026-08-17-filed-tasks-table-statuses.md` (KB
  `notion-7bb302edff13`, shipped `c65ca0bf`), which introduced `FiledDetailDialog`. That spec's
  detail-view acceptance criteria stay satisfied, through a page rather than a dialog.
