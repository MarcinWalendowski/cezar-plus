 ...
 *  neighbourhood — matching `notificationTransportAuthInputSchema` in `@loki-labs/cezar-plus-contract`,
 ...
 *  `transportAuthViewSchema` in `@loki-labs/cezar-plus-contract`. `hint` is the last four characters
