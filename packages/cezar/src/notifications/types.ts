 ...
 * `@open-mercato/cezar-contract` (`notifications.ts`, scaffold-owned); a future package adapts
...
/** Mirrors `notificationEventSchema` in `@open-mercato/cezar-contract` exactly — kept as a plain
