 ...
 *
 * Opt-out gate: skills from a *default* (vendor) skills repo — see `gatedSkillsRepos` —
 * appear unless the user has curated them away. cezar ships no default repo, so this tier is
