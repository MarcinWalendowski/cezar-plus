...
import { SPEC_TO_DEPLOY_CODEX_NAME, SPEC_TO_DEPLOY_WORKFLOW } from './types.ts';
...
describe('loadWorkflows derives spec-to-deploy-codex (V3)', () => {
  ...
  it('(a) with no .ai/cezar/workflows, the catalog has four entries including spec-to-deploy-codex', async () => {
