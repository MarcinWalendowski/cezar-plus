...
describe('workspace config', () => {
  ...
  it('a missing file behaves exactly like the defaults (zero-config, no warning)', async () => {
    ...
    expect(config.resources).toEqual({ maxParallel: 2, maxMonitoringSessions: 2, monitoringWakeIntervalMinutes: 5, autoResumeOnUsageLimit: true, memoryLimitMb: null, runMemoryHighMb: null, runMemoryMaxMb: null, runCpuWeight: null, runsSliceMemoryMaxMb: null, worktreeRetentionDefault: 1000 });
