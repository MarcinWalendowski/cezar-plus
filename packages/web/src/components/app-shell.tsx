        ...
        <>
          ...
          <div className="shrink-0 border-b border-border px-1.5 pt-0.5 pb-2">
            {/* TODO(upstream-sync): hardcodes AllTasksLink here instead of routing through a
                ...
                `items` (below) is what a `workspace: true` item like Notes is meant to render
                ...
                workspace item beyond AllTasksLink; one needs to land here before `CEZ_NOTES=1`
                is usable with more than one registered project. Not a regression today: with the
                flag off by default, this branch is unaffected either way. */}
